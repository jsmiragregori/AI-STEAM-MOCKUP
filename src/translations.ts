  ...
  es: {
    ...
    governance: {
      ...
      governanceBodies: [
        ...
        { id: 'sc', name: 'Comité Directivo', abbr: 'SC', type: 'Órgano ejecutivo', freq: 'Trimestral', quorum: 'Mayoría simple', members: 'UVEG (coord.), UMU, CEICE, TUV.IT, LC', desc: 'Gestión operativa del proyecto. Supervisa el plan de trabajo, aprueba los informes internos y coordina la coherencia entre Track A (Académico) y Track B (Ecosistema).', color: 'border-eu-teal bg-teal-50', iconColor: 'text-eu-teal' },
  ...
  en: {
    ...
    governance: {
      ...
      governanceBodies: [
        ...
        { id: 'sc', name: 'Steering Committee', abbr: 'SC', type: 'Executive body', freq: 'Quarterly', quorum: 'Simple majority', members: 'UVEG (coord.), UMU, CEICE, TUV.IT, LC', desc: 'Operational management of the project. Supervises the work plan, approves internal reports, and coordinates coherence between Track A (Academic) and Track B (Ecosystem).', color: 'border-eu-teal bg-teal-50', iconColor: 'text-eu-teal' },
        ...
        { id: 'sn', name: 'Stakeholder Network', abbr: 'SN', type: 'Participatory body (Track B)', freq: 'Biannual + Continuous online', quorum: 'Open participation', members: 'All stakeholders adhered through Collaboration Agreement', desc: 'Participatory body of Track B. Stakeholders propose challenges, vote priorities, and co-design curriculum via ConsensUE. CEICE acts as orchestrator of this space.', color: 'border-eu-orange bg-orange-50', iconColor: 'text-eu-orange' },
  ...
  va: {
    ...
    knowledge: {
      ...
      flowSteps: [
        ...
        { title: 'Case d\'Èxit OER', desc: 'La solució es publica com a recurs obert en el repositori de la xarxa' },
      ],
